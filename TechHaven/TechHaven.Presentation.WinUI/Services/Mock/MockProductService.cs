    ...
    public class MockProductService : IProductService
    {
        ...
        public MockProductService()
        {
            _mockProducts = new List<ProductDto>
                {
                    // ===== APPLE =====
                    new ProductDto { ProductId = 1, ProductName = "iPhone 15 Pro", BrandName = "Apple", Color = "Titan Gray", StorageCapacity = 256, Processor = "A17 Pro", ScreenSize = 6.1m, BatteryCapacity = 3274, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"iphone15pro1.jpg\",\"iphone15pro2.jpg\"]", SellPrice = 28990000, StockQuantity = 10, Description = "Flagship Apple 2025, hiệu năng cực mạnh", IsDraft = false },
                    ...
                    new ProductDto { ProductId = 4, ProductName = "iPhone 15 Plus", BrandName = "Apple", Color = "Pink", StorageCapacity = 256, Processor = "A16 Bionic", ScreenSize = 6.7m, BatteryCapacity = 4383, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"iphone15plus1.jpg\"]", SellPrice = 24990000, StockQuantity = 9, Description = "Màn hình lớn, pin bền", IsDraft = false },
                    new ProductDto { ProductId = 5, ProductName = "iPhone 14 Pro", BrandName = "Apple", Color = "Deep Purple", StorageCapacity = 256, Processor = "A16 Bionic", ScreenSize = 6.1m, BatteryCapacity = 3200, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"iphone14pro1.jpg\"]", SellPrice = 26990000, StockQuantity = 6, Description = "Dynamic Island thế hệ đầu", IsDraft = false },
                    ...
                    new ProductDto { ProductId = 7, ProductName = "iPhone SE (2022)", BrandName = "Apple", Color = "Red", StorageCapacity = 128, Processor = "A15 Bionic", ScreenSize = 4.7m, BatteryCapacity = 2018, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"iphonese2022.jpg\"]", SellPrice = 10990000, StockQuantity = 15, Description = "Giá mềm, chip mạnh", IsDraft = false },
                    ...
                    new ProductDto { ProductId = 10, ProductName = "iPhone 14 Plus", BrandName = "Apple", Color = "Yellow", StorageCapacity = 256, Processor = "A15 Bionic", ScreenSize = 6.7m, BatteryCapacity = 4323, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"iphone14plus.jpg\"]", SellPrice = 22990000, StockQuantity = 11, Description = "Pin tốt, màn hình lớn", IsDraft = false },

                    // ===== SAMSUNG =====
                    new ProductDto { ProductId = 11, ProductName = "Samsung Galaxy S24 Ultra", BrandName = "Samsung", Color = "Titanium Black", StorageCapacity = 512, Processor = "Snapdragon 8 Gen 3", ScreenSize = 6.8m, BatteryCapacity = 5000, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"s24ultra1.jpg\"]", SellPrice = 25990000, StockQuantity = 15, Description = "Camera 200MP, hỗ trợ bút S-Pen", IsDraft = false },
                    new ProductDto { ProductId = 12, ProductName = "Samsung Galaxy S24+", BrandName = "Samsung", Color = "Cobalt Violet", StorageCapacity = 256, Processor = "Snapdragon 8 Gen 3", ScreenSize = 6.7m, BatteryCapacity = 4700, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"s24plus1.jpg\"]", SellPrice = 23990000, StockQuantity = 12, Description = "Màn lớn, hiệu năng mạnh", IsDraft = false },
                    new ProductDto { ProductId = 13, ProductName = "Samsung Galaxy S24", BrandName = "Samsung", Color = "Marble Gray", StorageCapacity = 256, Processor = "Snapdragon 8 Gen 3", ScreenSize = 6.2m, BatteryCapacity = 4000, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"s24gray1.jpg\"]", SellPrice = 19990000, StockQuantity = 20, Description = "Nhỏ gọn, cao cấp", IsDraft = false },
                    ...
                    new ProductDto { ProductId = 15, ProductName = "Samsung Galaxy Z Flip5", BrandName = "Samsung", Color = "Mint", StorageCapacity = 256, Processor = "Snapdragon 8 Gen 2", ScreenSize = 6.7m, BatteryCapacity = 3700, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"zflip5.jpg\"]", SellPrice = 25990000, StockQuantity = 10, Description = "Gập dọc thời trang", IsDraft = false },
                    ...
                    new ProductDto { ProductId = 18, ProductName = "Samsung Galaxy S23 Ultra", BrandName = "Samsung", Color = "Cream", StorageCapacity = 512, Processor = "Snapdragon 8 Gen 2", ScreenSize = 6.8m, BatteryCapacity = 5000, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"s23ultra.jpg\"]", SellPrice = 22990000, StockQuantity = 10, Description = "Vẫn mạnh, giá tốt", IsDraft = false },
                    new ProductDto { ProductId = 19, ProductName = "Samsung Galaxy A15", BrandName = "Samsung", Color = "Light Blue", StorageCapacity = 128, Processor = "Helio G99", ScreenSize = 6.5m, BatteryCapacity = 5000, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"a15.jpg\"]", SellPrice = 4990000, StockQuantity = 35, Description = "Giá rẻ, pin trâu", IsDraft = false },
                    ...
                    // ===== XIAOMI =====
                    new ProductDto { ProductId = 21, ProductName = "Xiaomi 14T", BrandName = "Xiaomi", Color = "Mint Green", StorageCapacity = 256, Processor = "Dimensity 8300-Ultra", ScreenSize = 6.67m, BatteryCapacity = 5000, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"xiaomi14t1.jpg\"]", SellPrice = 14990000, StockQuantity = 20, Description = "Cấu hình mạnh, giá dễ tiếp cận", IsDraft = false },
                    new ProductDto { ProductId = 22, ProductName = "Xiaomi 14 Ultra", BrandName = "Xiaomi", Color = "White", StorageCapacity = 512, Processor = "Snapdragon 8 Gen 3", ScreenSize = 6.73m, BatteryCapacity = 5000, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"xiaomi14ultra.jpg\"]", SellPrice = 24990000, StockQuantity = 10, Description = "Camera Leica, flagship", IsDraft = false },
                    new ProductDto { ProductId = 23, ProductName = "Xiaomi 13T Pro", BrandName = "Xiaomi", Color = "Alpine Blue", StorageCapacity = 512, Processor = "Dimensity 9200+", ScreenSize = 6.67m, BatteryCapacity = 5000, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"13tpro.jpg\"]", SellPrice = 16990000, StockQuantity = 18, Description = "Camera Leica, giá tốt", IsDraft = false },
                    new ProductDto { ProductId = 24, ProductName = "Redmi Note 13 Pro+", BrandName = "Xiaomi", Color = "Aurora Purple", StorageCapacity = 256, Processor = "Dimensity 7200-Ultra", ScreenSize = 6.67m, BatteryCapacity = 5000, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"note13proplus.jpg\"]", SellPrice = 9990000, StockQuantity = 25, Description = "Tầm trung hiệu năng tốt", IsDraft = false },
                    ...
                    new ProductDto { ProductId = 27, ProductName = "POCO F6 Pro", BrandName = "Xiaomi", Color = "Black", StorageCapacity = 512, Processor = "Snapdragon 8 Gen 2", ScreenSize = 6.67m, BatteryCapacity = 5000, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"pocof6pro.jpg\"]", SellPrice = 15990000, StockQuantity = 22, Description = "Hiệu năng cao, giá tốt", IsDraft = false },
                    new ProductDto { ProductId = 28, ProductName = "POCO X6 Pro", BrandName = "Xiaomi", Color = "Yellow", StorageCapacity = 256, Processor = "Dimensity 8300 Ultra", ScreenSize = 6.67m, BatteryCapacity = 5000, ImageUrl = "./Assets/phone.jpg", ImageGalleryJson = "[\"pocox6pro.jpg\"]", SellPrice = 10990000, StockQuantity = 28, Description = "Máy gaming tầm trung", IsDraft = false },
